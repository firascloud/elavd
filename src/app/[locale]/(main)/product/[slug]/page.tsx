      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(getProductJsonLd(locale, {
            ...
            full_desc_ar: product.full_desc_ar ?? undefined,
            full_desc_en: product.full_desc_en ?? undefined,
            main_image: product.main_image ?? undefined,
            sku: product.sku ?? undefined,
            mpn: (product as { mpn?: string | null }).mpn ?? undefined,
            ...
            categoryName: product.category ? categoryName ?? undefined : undefined,
