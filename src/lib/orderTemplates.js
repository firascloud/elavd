export const adminOrderTemplate = ({ name, email, phone, city, message, total, items, productName, quantity }) => {
  ...
  <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f8fafc; padding: 50px 20px;">
    <div style="max-width: 650px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 10px 10px -5px rgba(0, 0, 0, 0.02); border: 1px solid #e2e8f0;">
      ...
      <div style="background-color: #0f172a; padding: 40px; text-align: center;">
        <h1 style="color: #ffffff; margin: 0; font-size: 22px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.1em;">New Quote Request</h1>
      ...
      <div style="padding: 40px;">
        <div style="margin-bottom: 35px;">
          ...
          <div style="background-color: #f8fafc; padding: 24px; border-radius: 16px; border: 1px solid #f1f5f9;">
            ...
            <div>
              <span style="color: #64748b; font-size: 11px; font-weight: 800; text-transform: uppercase; display: block; margin-bottom: 2px;">City</span>
              <span style="color: #0f172a; font-size: 16px; font-weight: 700;">${city || '—'}</span>
            </div>
          </div>
        </div>

        <div style="margin-bottom: 35px;">
          <h2 style="font-size: 12px; font-weight: 900; color: #64748b; text-transform: uppercase; letter-spacing: 0.15em; margin: 0 0 15px; border-left: 4px solid #3b82f6; padding-left: 12px;">Inquiry Summary</h2>
        ...
        <div style="margin-bottom: 20px;">
          <h2 style="font-size: 12px; font-weight: 900; color: #64748b; text-transform: uppercase; letter-spacing: 0.15em; margin: 0 0 15px; border-left: 4px solid #3b82f6; padding-left: 12px;">Customer Question</h2>
